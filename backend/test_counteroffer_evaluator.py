...
def test_deadlock_detects_stalled_recent_rounds():
    history = [
        {"round": 1, "agent": "A", "offer": 58000},
        {"round": 1, "agent": "B", "offer": 52000},
        {"round": 2, "agent": "A", "offer": 53100},
        {"round": 2, "agent": "B", "offer": 53000},
        {"round": 3, "agent": "A", "offer": 53200},
        {"round": 3, "agent": "B", "offer": 53300},
    ]

    assert detect_deadlock(history, n_rounds=2) is True

def test_deadlock_does_not_trigger_on_meaningful_movement():
    history = [
        {"round": 1, "agent": "A", "offer": 60000},
        {"round": 1, "agent": "B", "offer": 45000},
        {"round": 2, "agent": "A", "offer": 58000},
        {"round": 2, "agent": "B", "offer": 47000},
        {"round": 3, "agent": "A", "offer": 55000},
        {"round": 3, "agent": "B", "offer": 50000},
    ]
